...
Route::prefix('admin')->middleware('admin')->group(function () {
	...
	Route::prefix('publication')->group(function () {
		Route::get('/view', [SupplierController::class, 'SupplierView'])->name('publication.all');
		Route::get('/create', [SupplierController::class, 'create'])->name('publication.create');
		Route::post('/create', [SupplierController::class, 'store'])->name('publication.store');
		Route::get('/edit/{id}', [SupplierController::class, 'edit'])->name('publication.edit');
		Route::post('/update/{id}', [SupplierController::class, 'update'])->name('publication.update');
		Route::get('/delete/{id}', [SupplierController::class, 'destroy'])->name('publication.destroy');
		Route::get('/supplier_active/{id}', [SupplierController::class, 'active'])->name('publication.active');
		Route::get('/supplier_inactive/{id}', [SupplierController::class, 'inactive'])->name('publication.in_active');
	});
	...
	Route::resource('/writer', VendorController::class);
	Route::get('/writer/delete/{id}', [VendorController::class, 'destroy'])->name('writer.delete');
	Route::get('/writer_active/{id}', [VendorController::class, 'active'])->name('writer.active');
	Route::get('/writer_inactive/{id}', [VendorController::class, 'inactive'])->name('writer.in_active');
