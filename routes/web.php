...
// All Authors List Start
Route::get('/authors',[FrontendController::class, 'AuthorList'])->name('authors');
// All Authors List end

// All Publications List Start
Route::get('/publications',[FrontendController::class, 'PublicationList'])->name('publications');
// All Publications List end
...
/* ===============  Writer Wise Product Show  ============= */
Route::get('/writer-product/{slug}',[FrontendController::class, 'VendorWiseProduct'])->name('writer.product');

/* ===============  Publication Wise Product Show  ============= */
Route::get('/publication-product/{id}',[FrontendController::class, 'PublicationWiseProduct'])->name('publication.product');
...
Route::get('/product/package-books',[ProductController::class,'PackageBooks'])->name('product.package.books');
Route::get('/product/recently-sell-books',[ProductController::class,'RecentlySellBooks'])->name('product.recently-sell.books');
/* =============== sort_by  ============= */
