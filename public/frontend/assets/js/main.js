    ...
    $("[data-countdown]").each(function () {
        ...
        $this.countdown(finalDate, function (event) {
            ...
            $(this).html(
                ...
                '<span class="countdown-section"><span class="countdown-amount hover-up">' + hours + '</span>   Hours </span>' +
                '<span class="countdown-section"><span class="countdown-amount hover-up">' + minutes + '</span>   Minits </span>' +
                '<span class="countdown-section"><span class="countdown-amount hover-up">' + seconds + '</span>  Second</span>'
            );
        });
    });
