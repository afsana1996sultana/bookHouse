...
class PosController extends Controller
{
    ...
    public function index()
    {
        ...
        $customers = User::where('role', 3)->where('customer_type', 1)->where('status', 1)->latest()->get();
    ...
    {
        $customers = User::where('role', 3)->where('customer_type', 1)->where('status', 1)->latest('updated_at')->get();
        return json_encode($customers);
    }
