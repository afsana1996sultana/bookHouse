                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="invoice-number">
                                            ...
                                            <p class="invoice-addr-1 text-capitalize text_color">
                                                <strong class="text_color">Name: {{ $order->name ?? '' }}</strong> <br />
                                                <strong class="text_color">Address: {{ $order->address ?? '' }},
                                                {{ $order->upazilla->name_en ?? '' }}, {{ $order->district->district_name_en ?? '' }}</strong> <br>
                                                <strong class="text_color">Phone:</strong> {{ $order->phone ?? ''}}<br>
                                                @if($order->email)
                                                    <strong class="text_color">Email: </strong>{{ $order->email ?? ''}}<br>
                                                @endif
                                            </p>
                                        </div>
                                    </div>
