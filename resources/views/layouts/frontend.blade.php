                                ...
                                <ul class="nav flex-column dropdown__body">
                                    ...
                                    <li class="nav-item">
                                        <div class="d-flex align-items-center" style="justify-content: space-between">
                                            <a class="nav-link-item" href="{{ route('product.category', $category->slug) }}">
                        ...
                        <div class="nav__item">
                            ...
                            <div class="collapse" id="moreOptions1">
                                <ul class="nav flex-column dropdown__body">
                                    ...
                                    <li class="nav-item">
                                        <div class="d-flex align-items-center" style="justify-content: space-between">
                                            <a class="nav-link-item" href="{{ route('page.about', $page->slug) }}">
                                                {{ $page->title }}
                                            </a>
                                        </div>
                                    </li>
                        ...
                        <div class="nav__item">
                            ...
                            <div class="collapse" id="moreOptions2">
                                <ul class="nav flex-column dropdown__body">
                                    ...
                                    <li class="nav-item">
                                        <div class="d-flex align-items-center" style="justify-content: space-between">
                                            <a class="nav-link-item" href="{{ route('english.language') }}">English</a>
                                        </div>
                                    </li>
                                    @else
                                    <li class="nav-item">
                                        <div class="d-flex align-items-center" style="justify-content: space-between">
                                            <a class="nav-link-item" href="{{ route('bangla.language') }}">বাংলা</a>
                                        </div>
                                    </li>
                                    @endif
                                    @endforeach
