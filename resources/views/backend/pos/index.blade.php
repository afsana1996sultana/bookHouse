                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('customer.ajax.store.pos') }}" method="Post"
                                                            ...
                                                            <div class="row gy-3">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="name" class="form-control rounded-0" id="name" placeholder="Input Your Name" oninput="validateNameInput()" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="" class="form-label"><span class="text-danger">*</span>Mobile:</label>
                                                                        <input type="number" name="phone" class="form-control rounded-0" id="numberInput" oninput="validateNumberInput(this)"  placeholder="Mobile Number *" required/>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="" class="form-label">Email:</label>
                                                                        <input type="email" name="email" class="form-control rounded-0" placeholder="Input Email">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label for="district_id" class="form-label"><span class="text-danger">*</span> District</label>
                                                                    <select class="form-control select-new" aria-label="Default select example" name="district_id" id="district_id" required>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select class="form-control select-new" aria-label="Default select example" name="upazilla_id" id="upazilla_id" required>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="" class="form-label"><span class="text-danger">*</span>House/Road/Area:</label>
                                                                        <input type="text" name="address" class="form-control rounded-0" placeholder="House/Road/Area" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn_main footer_innerbtn misty-color usersave">Save</button>
                    ...
                    <div class="product__table_content">
                        ...
                        <div class="product__table">
                            ...
                            <table class="table table-condensed table-bordered table-responsive">
                                ...
                                <!-- table body -->
                                <tbody class="cartItem__product"></tbody>
                            </table>
                        </div>
                        <!-- table footer -->
