...
<section class="content-main">
    <div class="content-header">
        <h2 class="content-title">Edit Subject</h2>
        <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" action="{{ route('category.update', $category->id) }}"
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-md-3 col-form-label">Parent Subject</label>
                                    <div class="col-md-9">
                                ...
                                <div class="mb-4">
                                    <label for="image" class="col-form-label" style="font-weight: bold;"> Subject Image:</label>
                                ...
                                <div class="mb-4">
                                    <label for="banner_image" class="col-form-label" style="font-weight: bold;"> Banner Image:</label>
                                    <input name="banner_image" class="form-control" type="file" id="banner_image">
                                </div>
                                <div class="mb-4">
                                    <img id="showImage" class="rounded avatar-lg" src="{{ asset($category->banner_image) }}"
                                        alt="Card image cap" width="100px" height="80px;">
                                </div>
