                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select class="form-control select-active" name="district_id" id="district_id"
                                            required @if ($order->user_id == 1) @endif>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control" name="address" value="{{ $order->address ?? 'Null' }}" @if ($order->user_id == 1) @endif>
                                    </td>
                                </tr>
                                <tr>
